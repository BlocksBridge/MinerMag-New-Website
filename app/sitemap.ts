...
let staticPages =  [{priority: 0.6, changeFrequency: "yearly", url:process.env.NEXT_PUBLIC_website_url + "/disclaimer" },{priority: 0.6, changeFrequency: "yearly", url:process.env.NEXT_PUBLIC_website_url + "/privacy-policy" },{priority: 0.6, changeFrequency: "yearly", url:process.env.NEXT_PUBLIC_website_url + "/contact-us" }]
